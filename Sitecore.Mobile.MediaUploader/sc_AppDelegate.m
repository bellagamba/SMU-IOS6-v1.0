...
-(void)initializeStoryBoardBasedOnScreenSize {
    ...
    _appDataObject.isOnline = [sc_ConnectivityHelper connectedToInternet];
...
- (void)applicationDidEnterBackground:(UIApplication *)application {
    ...
    [(UINavigationController *)self.window.rootViewController dismissModalViewControllerAnimated:NO];
